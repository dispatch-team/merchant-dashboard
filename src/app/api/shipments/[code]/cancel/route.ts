...
export async function POST(
  ...
  try {
    ...
    const url = `${API_BASE}/${encodeURIComponent(code)}/cancel`;
    
    // Explicitly check for remark as the user specified it in the example
    if (!body.remark) {
      body.remark = "Cancelled by merchant";
    }
    ...
    console.error("Shipment cancel POST failed:", err);
